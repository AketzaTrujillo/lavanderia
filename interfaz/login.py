    ...
    def verificar(self):
        ...
        try:
            ...
            if resultado:
                ...
                # Abrir panel según rol y pasar el ID de usuario
                if rol == "admin":
                    from admin_view import MasterPanel
                    panel_admin = MasterPanel()
                    panel_admin.id_usuario = id_usuario  # Asignar ID de usuario
                elif rol == "cajero":
                    from cajero_view import CajeroPanel
                    panel_cajero = CajeroPanel(id_usuario)  # Pasar ID directamente al constructor
                else:
